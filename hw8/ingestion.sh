...
hdfs dfs -mv netflix_titles.csv ./dataset/netflix-shows/
hdfs dfs -mv combined_data_1.txt combined_data_2.txt combined_data_3.txt combined_data_4.txt movie_titles.csv data.csv ./dataset/assignment-matrix/
